!(function (t, e) {
  ...
  n(document).on(Q.CLICK_DATA_API, G, function (t) {
    ...
    (n.fn[W] = J._jQueryInterface),
    (n.fn[W].Constructor = J),
    (n.fn[W].noConflict = function () {
      return (n.fn[W] = q), J._jQueryInterface;
    });
  var Z = "dropdown",
    $ = "bs.dropdown",
    tt = "." + $,
      ...
      return (
        ...
        (e.show = function (t) {
          ...
          if (!this._isShown && !this._isTransitioning) {
            ...
            var i = n.Event(Et.SHOW, { relatedTarget: t });
          ...
          if (
            ...
            if (
              ...
              if (
                ...
                this._setEscapeEvent(),
                this._setResizeEvent(),
                n(document).off(Et.FOCUSIN),
                n(this._element).removeClass(Tt),
                n(this._element).off(Et.CLICK_DISMISS),
                n(this._dialog).off(Et.MOUSEDOWN_DISMISS),
                o)
              ) {
        ...
        (e._showElement = function (t) {
          ...
          (this._element.parentNode &&
            ...
            n(this._element).addClass(Tt),
            this._config.focus && this._enforceFocus();
          var o = n.Event(Et.SHOWN, { relatedTarget: t }),
            r = function () {
        ...
        (e._setEscapeEvent = function () {
          ...
          this._isShown && this._config.keyboard
            ? n(this._element).on(Et.KEYDOWN_DISMISS, function (e) {
        ...
        (e._setResizeEvent = function () {
          var t = this;
          this._isShown
            ? n(window).on(Et.RESIZE, function (e) {
        ...
        (e._hideModal = function () {
          ...
          (this._element.style.display = "none"),
            ...
            (this._isTransitioning = !1),
            this._showBackdrop(function () {
              n(document.body).removeClass(yt),
                t._resetAdjustments(),
                t._resetScrollbar(),
                n(t._element).trigger(Et.HIDDEN);
            });
        }),
        ...
        (e._showBackdrop = function (t) {
          ...
          if (this._isShown && this._config.backdrop) {
            if (
              ...
              n(this._element).on(Et.CLICK_DISMISS, function (t) {
        ...
        (t._jQueryInterface = function (e, i) {
          return this.each(function () {
            ...
            if (
              (o || ((o = new t(this, s)), n(this).data(gt, o)),
              "string" == typeof e)
            ) {
              if (void 0 === o[e])
                throw new TypeError('No method named "' + e + '"');
  ...
  n(document).on(Et.CLICK_DATA_API, '[data-toggle="modal"]', function (t) {
    ...
    It._jQueryInterface.call(n(e), s, this);
  }),
    (n.fn[dt] = It._jQueryInterface),
    (n.fn[dt].Constructor = It),
    (n.fn[dt].noConflict = function () {
      return (n.fn[dt] = mt), It._jQueryInterface;
    });
  var Dt = "tooltip",
    wt = "bs.tooltip",
    At = "." + wt,
      ...
      return (
        ...
        (i.toggle = function (t) {
          if (this._isEnabled)
            if (t) {
              ...
              if (n(this.getTipElement()).hasClass(xt))
        ...
        (i.show = function () {
          ...
          if (this.isWithContent() && this._isEnabled) {
            ...
            s.setAttribute("id", l),
              ...
              this.setContent(),
              this.config.animation && n(s).addClass(Wt);
            var c =
        ...
        (i._enter = function (t, e) {
          ...
          (e = e || n(t.currentTarget).data(i)) ||
            ...
            n(e.getTipElement()).hasClass(xt) || e._hoverState === Ht
              ? (e._hoverState = Ht)
        ...
        (i._getConfig = function (t) {
          return (
            ...
            a.typeCheckConfig(Dt, t, this.constructor.DefaultType),
            t
          );
        }),
        ...
        (t._jQueryInterface = function (e) {
          return this.each(function () {
            var i = n(this).data(wt),
              o = "object" == typeof e && e;
            if (
              (i || !/dispose|hide/.test(e)) &&
              (i || ((i = new t(this, o)), n(this).data(wt, i)),
              "string" == typeof e)
            ) {
              if (void 0 === i[e])
                throw new TypeError('No method named "' + e + '"');
  ...
  (n.fn[Dt] = Mt._jQueryInterface),
    (n.fn[Dt].Constructor = Mt),
    (n.fn[Dt].noConflict = function () {
      return (n.fn[Dt] = Nt), Mt._jQueryInterface;
    });
  var Kt = "popover",
    Qt = "bs.popover",
    Bt = "." + Qt,
    ...
    Gt = r({}, Mt.DefaultType, { content: "(string|element|function)" }),
    Jt = {
      HIDE: "hide" + Bt,
      HIDDEN: "hidden" + Bt,
      SHOW: "show" + Bt,
        ...
        (r._jQueryInterface = function (t) {
          return this.each(function () {
            ...
            if (
              ...
              (e || ((e = new r(this, i)), n(this).data(Qt, e)),
              "string" == typeof t)
            ) {
              if (void 0 === e[t])
  ...
  (n.fn[Kt] = Zt._jQueryInterface),
    (n.fn[Kt].Constructor = Zt),
      ...
      return (
        ...
        (e._getConfig = function (t) {
          if (
            ...
            e || ((e = a.getUID($t)), n(t.target).attr("id", e)),
              (t.target = "#" + e);
          }
  ...
  n(window).on(re.LOAD_DATA_API, function () {
    ...
    (n.fn[$t] = ue._jQueryInterface),
    (n.fn[$t].Constructor = ue),
    (n.fn[$t].noConflict = function () {
      return (n.fn[$t] = ne), ue._jQueryInterface;
    });
  var fe = "bs.tab",
    de = "." + fe,
    ge = n.fn.tab,
      ...
      return (
        (e.show = function () {
          ...
          if (
            ...
            var l = n.Event(_e.HIDE, { relatedTarget: this._element }),
              c = n.Event(_e.SHOW, { relatedTarget: i });
            if (
              (i && n(i).trigger(l),
              ...
              var h = function () {
                var e = n.Event(_e.HIDDEN, { relatedTarget: t._element }),
                  o = n.Event(_e.SHOWN, { relatedTarget: i });
        ...
        (e.dispose = function () {
          n.removeData(this._element, fe), (this._element = null);
        }),
        ...
        (t._jQueryInterface = function (e) {
          return this.each(function () {
            var i = n(this),
              o = i.data(fe);
            if (
              (o || ((o = new t(this)), i.data(fe, o)), "string" == typeof e)
            ) {
              if (void 0 === o[e])
                throw new TypeError('No method named "' + e + '"');
              o[e]();
  ...
  n(document).on(
    ...
    (n.fn.tab = ye._jQueryInterface),
    (n.fn.tab.Constructor = ye),
    (n.fn.tab.noConflict = function () {
      return (n.fn.tab = ge), ye._jQueryInterface;
    });
  var Ce = "toast",
    Te = "bs.toast",
    Se = "." + Te,
    ...
    ke = (function () {
      ...
      return (
        (e.show = function () {
          var t = this;
          n(this._element).trigger(Ie.SHOW),
            this._config.animation && this._element.classList.add("fade");
          var e = function () {
            t._element.classList.remove(Ae),
              t._element.classList.add(we),
              n(t._element).trigger(Ie.SHOWN),
        ...
        (e.hide = function (t) {
          ...
          this._element.classList.contains(we) &&
            (n(this._element).trigger(Ie.HIDE),
            t
              ? this._close()
        ...
        (e.dispose = function () {
          clearTimeout(this._timeout),
            ...
            n(this._element).off(Ie.CLICK_DISMISS),
            n.removeData(this._element, Te),
            (this._element = null),
            (this._config = null);
        }),
        (e._getConfig = function (t) {
          return (
            ...
            a.typeCheckConfig(Ce, t, this.constructor.DefaultType),
            t
          );
        }),
        ...
        (e._close = function () {
          var t = this,
            e = function () {
              t._element.classList.add(De), n(t._element).trigger(Ie.HIDDEN);
            };
        ...
        (t._jQueryInterface = function (e) {
          return this.each(function () {
            ...
            if (
              (o ||
                ((o = new t(this, "object" == typeof e && e)), i.data(Te, o)),
              "string" == typeof e)
            ) {
              if (void 0 === o[e])
                throw new TypeError('No method named "' + e + '"');
  ...
  (n.fn[Ce] = ke._jQueryInterface),
    (n.fn[Ce].Constructor = ke),
    (n.fn[Ce].noConflict = function () {
      return (n.fn[Ce] = be), ke._jQueryInterface;
    }),
    (function () {
      if (void 0 === n)
        throw new TypeError(
